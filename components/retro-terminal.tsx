...
const themes = {
  ...
  ally: {
    ...
    dark: {
      ...
      "--background": "oklch(0.15 0.05 350)",
      "--foreground": "oklch(0.95 0.02 340)",
      "--card": "oklch(0.2 0.06 350)",
      "--card-foreground": "oklch(0.95 0.02 340)",
      "--popover": "oklch(0.18 0.05 350)",
      "--popover-foreground": "oklch(0.95 0.02 340)",
      "--secondary": "oklch(0.7 0.2 85)",
      "--secondary-foreground": "oklch(0.15 0.05 350)",
      "--muted": "oklch(0.25 0.05 350)",
      "--muted-foreground": "oklch(0.7 0.05 340)",
      "--accent": "oklch(0.8 0.22 90)",
      "--accent-foreground": "oklch(0.15 0.05 350)",
      "--destructive": "oklch(0.6 0.28 20)",
      "--destructive-foreground": "oklch(0.95 0.02 340)",
      "--border": "oklch(0.75 0.25 350)",
      "--input": "oklch(0.75 0.25 350)",
      "--ring": "oklch(0.75 0.25 350)",
      "--chart-1": "oklch(0.75 0.25 350)",
      "--chart-2": "oklch(0.7 0.2 85)",
      "--chart-3": "oklch(0.65 0.22 340)",
      "--chart-4": "oklch(0.75 0.18 95)",
      "--chart-5": "oklch(0.8 0.22 90)",
      "--visitor-counter": "oklch(0.7 0.25 350)",
      "--shadow-color": "oklch(0.75 0.25 350 / 0.4)",
